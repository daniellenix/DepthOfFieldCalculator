        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(lensIdx == -1) {
                    ...
                    if(userMakeInput.trim().isEmpty()) {
                        makeText.setError("Must have input");
                    } else if(focalLengthText.getText().toString().trim().isEmpty()) {
                        focalLengthText.setError("Must have input");
                    } else if(apertureText.getText().toString().trim().isEmpty()) {
                        ...
                        if(selected == 2131230907) {
                            manager.add(new Lens(userMakeInput, userApertureInput, userFocalLengthInput, R.drawable.camera1));
                        } else if(selected == 2131230908) {
                            manager.add(new Lens(userMakeInput, userApertureInput, userFocalLengthInput, R.drawable.camera2));
                        }else if(selected == 2131230909) {
                            manager.add(new Lens(userMakeInput, userApertureInput, userFocalLengthInput, R.drawable.camera3));
                        }else if(selected == 2131230910) {
                            manager.add(new Lens(userMakeInput, userApertureInput, userFocalLengthInput, R.drawable.camera4));
                        }else if(selected == 2131230911) {
                            manager.add(new Lens(userMakeInput, userApertureInput, userFocalLengthInput, R.drawable.camera5));
                        }
